...
public :
   ...
   vector<int>     *genJets_decayFromBHadron;
   vector<int>     *genJets_decayFromCHadron;
   ...
   TBranch        *b_genJets_m;   //!
   TBranch        *b_genJets_decayFromBHadron;   //!
   TBranch        *b_genJets_decayFromCHadron;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/cern.ch/work/y/youngjo/public/For8Tev/KrAFT_20140224/TTJets_FullLeptMGDecays_8TeV-madgraph-tauola.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/afs/cern.ch/work/y/youngjo/public/For8Tev/KrAFT_20140224/TTJets_FullLeptMGDecays_8TeV-madgraph-tauola.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/afs/cern.ch/work/y/youngjo/public/For8Tev/KrAFT_20140224/TTJets_FullLeptMGDecays_8TeV-madgraph-tauola.root:/MuMu");
...
void Event::Init(TTree *tree)
{
   ...
   genJets_phi = 0;
   genJets_m = 0;
   genJets_decayFromBHadron = 0;
   genJets_decayFromCHadron = 0;
   genParticles_pt = 0;
   genParticles_eta = 0;
   genParticles_phi = 0;
   genParticles_m = 0;
   ...
   fChain->SetBranchAddress("genJets_decayFromBHadron", &genJets_decayFromBHadron, &b_genJets_decayFromBHadron);
   fChain->SetBranchAddress("genJets_decayFromCHadron", &genJets_decayFromCHadron, &b_genJets_decayFromCHadron);
