...
const int nBkg = 4;
const char* bkgNames[] = {"TTm1b",
 "TTmcc","TTmLF","TTm_",
//const char* bkgNames[] = {"TTp1b",
// "TTpcc","TTpLF","TTp_",
//const char* bkgNames[] = {"TTat1b",
// "TTatcc","TTatLF","TTat_",
//"Wj_", "VV_",
// "ST_", "DY_"
//,"hDataBkg_QCD"
...
const int nSig = 1;
const char* sigNames[] = {"TTmbb"};//"hMCSig_TTbarH125"};
//const char* sigNames[] = {"TTpbb"};//"hMCSig_TTbarH125"};
//const char* sigNames[] = {"TTatbb"};//"hMCSig_TTbarH125"};
...
/////////////////////////////
void cutflowTTbar(const char * samplename)
{

//TTJets_FullLeptMGDecays_8TeV-madgraph-tauola.root
//result_TTTo2L2Nu2B_8TeV-powheg-pythia6.root
//result_TT_8TeV-mcatnlo.root

   f=TFile::Open(Form("./result_%s.root",samplename));
//   outDirName += Form("/%s",samplename);
...
//     if ( doLogY ){ pad1[i]->SetLogy(); h2[i]->SetMinimum(LogMin[i]); h2[i]->SetMaximum(h2[i]->GetMaximum()*500); }
     if ( doLogY ){ c[i]->SetLogy(); h2[i]->SetMinimum(LogMin[i]); h2[i]->SetMaximum(h2[i]->GetMaximum()*500); }
