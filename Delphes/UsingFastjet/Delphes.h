...
// Mon May 18 16:53:38 2015 by ROOT version 6.02/02
// from TTree Delphes/Analysis tree
// found on file: /cms/data/xrd/store/user/youngjo/Madgraph/DATA/v20140916/v20140911_ttbb_test_cut_bq_events_PYTHIA8_0.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static const Int_t kMaxParticle = 3795;
   static const Int_t kMaxTrack = 422;
   static const Int_t kMaxTower = 668;
   static const Int_t kMaxEFlowTrack = 422;
   static const Int_t kMaxEFlowPhoton = 387;
   static const Int_t kMaxEFlowNeutralHadron = 427;
   static const Int_t kMaxGenJet = 51;
   static const Int_t kMaxJet = 58;
   static const Int_t kMaxElectron = 7;
   static const Int_t kMaxPhoton = 7;
   static const Int_t kMaxMuon = 7;
   ...
   virtual bool isBHadron(const int idx_ ) const;
   virtual bool isBHadronC(const unsigned int absPdgId) const;
   virtual bool isFromHadron(const int idx_) const;
};
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/cms/data/xrd/store/user/youngjo/Madgraph/DATA/v20140916/v20140911_ttbb_test_cut_bq_events_PYTHIA8_0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/cms/data/xrd/store/user/youngjo/Madgraph/DATA/v20140916/v20140911_ttbb_test_cut_bq_events_PYTHIA8_0.root");
      }
