...
//   Sample ttjj_3 = Sample(path+"/result_ttjj_LO.root","ntuple","ttjj_3","t#bar{t}jj LO "    ,kBlue+1,1,2,true,423.55676178935778,1); // xsec unit : pb
  ...
  Sample MC[] = {ttbb_4, tth_4,ttjj_1,ttjj_4};
...
////////////                 
 MonitorPlot MyPlots[] = {
  ...
  char *hname[] = {"ttbb","tth","ttjjNLO", "ttjjLO"};
  const double ttbb_cx = 4.729;
  const double tth_cx  = 0.4455;
  const double ttjj_cx = 424.14756200450773;
  const double ttjjNLO_cx = 223.8;
  double cxxx[] = { ttbb_cx, tth_cx, ttjjNLO_cx,ttjj_cx};
/////////////////////
