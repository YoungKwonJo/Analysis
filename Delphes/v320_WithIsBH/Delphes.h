...
// Thu Jul  9 19:22:22 2015 by ROOT version 6.05/01
// from TTree Delphes/Analysis tree
// found on file: ../test18.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           Particle_size;
   Int_t           BHadron_;
   UInt_t          BHadron_fUniqueID[kMaxBHadron];   //[BHadron_]
   UInt_t          BHadron_fBits[kMaxBHadron];   //[BHadron_]
   Int_t           BHadron_PID[kMaxBHadron];   //[BHadron_]
   Int_t           BHadron_Status[kMaxBHadron];   //[BHadron_]
   Int_t           BHadron_IsPU[kMaxBHadron];   //[BHadron_]
   Int_t           BHadron_M1[kMaxBHadron];   //[BHadron_]
   Int_t           BHadron_M2[kMaxBHadron];   //[BHadron_]
   Int_t           BHadron_D1[kMaxBHadron];   //[BHadron_]
   Int_t           BHadron_D2[kMaxBHadron];   //[BHadron_]
   Int_t           BHadron_Charge[kMaxBHadron];   //[BHadron_]
   Float_t         BHadron_Mass[kMaxBHadron];   //[BHadron_]
   Float_t         BHadron_E[kMaxBHadron];   //[BHadron_]
   Float_t         BHadron_Px[kMaxBHadron];   //[BHadron_]
   Float_t         BHadron_Py[kMaxBHadron];   //[BHadron_]
   Float_t         BHadron_Pz[kMaxBHadron];   //[BHadron_]
   Float_t         BHadron_PT[kMaxBHadron];   //[BHadron_]
   Float_t         BHadron_Eta[kMaxBHadron];   //[BHadron_]
   Float_t         BHadron_Phi[kMaxBHadron];   //[BHadron_]
   Float_t         BHadron_Rapidity[kMaxBHadron];   //[BHadron_]
   Float_t         BHadron_T[kMaxBHadron];   //[BHadron_]
   Float_t         BHadron_X[kMaxBHadron];   //[BHadron_]
   Float_t         BHadron_Y[kMaxBHadron];   //[BHadron_]
   Float_t         BHadron_Z[kMaxBHadron];   //[BHadron_]
   Int_t           BHadron_size;
   Int_t           Track_;
   ...
   Int_t           Tower_Ntimes[kMaxTower];   //[Tower_]
   ...
   Int_t           EFlowPhoton_Ntimes[kMaxEFlowPhoton];   //[EFlowPhoton_]
   ...
   Int_t           EFlowNeutralHadron_Ntimes[kMaxEFlowNeutralHadron];   //[EFlowNeutralHadron_]
   ...
   Int_t           GenJet_IsBH[kMaxGenJet];   //[GenJet_]
   ...
   TBranch        *b_BHadron_;   //!
   TBranch        *b_BHadron_fUniqueID;   //!
   TBranch        *b_BHadron_fBits;   //!
   TBranch        *b_BHadron_PID;   //!
   TBranch        *b_BHadron_Status;   //!
   TBranch        *b_BHadron_IsPU;   //!
   TBranch        *b_BHadron_M1;   //!
   TBranch        *b_BHadron_M2;   //!
   TBranch        *b_BHadron_D1;   //!
   TBranch        *b_BHadron_D2;   //!
   TBranch        *b_BHadron_Charge;   //!
   TBranch        *b_BHadron_Mass;   //!
   TBranch        *b_BHadron_E;   //!
   TBranch        *b_BHadron_Px;   //!
   TBranch        *b_BHadron_Py;   //!
   TBranch        *b_BHadron_Pz;   //!
   TBranch        *b_BHadron_PT;   //!
   TBranch        *b_BHadron_Eta;   //!
   TBranch        *b_BHadron_Phi;   //!
   TBranch        *b_BHadron_Rapidity;   //!
   TBranch        *b_BHadron_T;   //!
   TBranch        *b_BHadron_X;   //!
   TBranch        *b_BHadron_Y;   //!
   TBranch        *b_BHadron_Z;   //!
   TBranch        *b_BHadron_size;   //!
   TBranch        *b_Track_;   //!
   ...
   TBranch        *b_EFlowNeutralHadron_Ntimes;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../test18.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../test18.root");
      }
...
void Delphes::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("BHadron", &BHadron_, &b_BHadron_);
   fChain->SetBranchAddress("BHadron.fUniqueID", BHadron_fUniqueID, &b_BHadron_fUniqueID);
   fChain->SetBranchAddress("BHadron.fBits", BHadron_fBits, &b_BHadron_fBits);
   fChain->SetBranchAddress("BHadron.PID", BHadron_PID, &b_BHadron_PID);
   fChain->SetBranchAddress("BHadron.Status", BHadron_Status, &b_BHadron_Status);
   fChain->SetBranchAddress("BHadron.IsPU", BHadron_IsPU, &b_BHadron_IsPU);
   fChain->SetBranchAddress("BHadron.M1", BHadron_M1, &b_BHadron_M1);
   fChain->SetBranchAddress("BHadron.M2", BHadron_M2, &b_BHadron_M2);
   fChain->SetBranchAddress("BHadron.D1", BHadron_D1, &b_BHadron_D1);
   fChain->SetBranchAddress("BHadron.D2", BHadron_D2, &b_BHadron_D2);
   fChain->SetBranchAddress("BHadron.Charge", BHadron_Charge, &b_BHadron_Charge);
   fChain->SetBranchAddress("BHadron.Mass", BHadron_Mass, &b_BHadron_Mass);
   fChain->SetBranchAddress("BHadron.E", BHadron_E, &b_BHadron_E);
   fChain->SetBranchAddress("BHadron.Px", BHadron_Px, &b_BHadron_Px);
   fChain->SetBranchAddress("BHadron.Py", BHadron_Py, &b_BHadron_Py);
   fChain->SetBranchAddress("BHadron.Pz", BHadron_Pz, &b_BHadron_Pz);
   fChain->SetBranchAddress("BHadron.PT", BHadron_PT, &b_BHadron_PT);
   fChain->SetBranchAddress("BHadron.Eta", BHadron_Eta, &b_BHadron_Eta);
   fChain->SetBranchAddress("BHadron.Phi", BHadron_Phi, &b_BHadron_Phi);
   fChain->SetBranchAddress("BHadron.Rapidity", BHadron_Rapidity, &b_BHadron_Rapidity);
   fChain->SetBranchAddress("BHadron.T", BHadron_T, &b_BHadron_T);
   fChain->SetBranchAddress("BHadron.X", BHadron_X, &b_BHadron_X);
   fChain->SetBranchAddress("BHadron.Y", BHadron_Y, &b_BHadron_Y);
   fChain->SetBranchAddress("BHadron.Z", BHadron_Z, &b_BHadron_Z);
   fChain->SetBranchAddress("BHadron_size", &BHadron_size, &b_BHadron_size);
   ...
   fChain->SetBranchAddress("Tower.Ntimes", Tower_Ntimes, &b_Tower_Ntimes);
   ...
   fChain->SetBranchAddress("EFlowPhoton.Ntimes", EFlowPhoton_Ntimes, &b_EFlowPhoton_Ntimes);
   ...
   fChain->SetBranchAddress("EFlowNeutralHadron.Ntimes", EFlowNeutralHadron_Ntimes, &b_EFlowNeutralHadron_Ntimes);
   ...
   fChain->SetBranchAddress("GenJet.IsBH", GenJet_IsBH, &b_GenJet_IsBH);
   ...
   fChain->SetBranchAddress("Jet.IsBH", Jet_IsBH, &b_Jet_IsBH);
