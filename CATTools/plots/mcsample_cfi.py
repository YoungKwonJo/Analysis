...
{"name":"ttot",  "selection": ttothers, "file": loc + "result_"+ttbar+".root", "cx":ttcx, "color": kGray,    "lineWidth": 4, "label":"t#bar{t} others"         },

{"name":"STbt",   "selection": "(1)", "file": loc + "result_SingleTbar_t.root",  "cx":80.95,  "color": kGray, "lineWidth": 4, "label":"SingleTopBar t"    },
{"name":"STbtW",  "selection": "(1)", "file": loc + "result_SingleTbar_tW.root", "cx":35.6,   "color": kGray, "lineWidth": 4, "label":"SingleTopBar tW"   },
{"name":"STt",    "selection": "(1)", "file": loc + "result_SingleTop_t.root",   "cx":136.02, "color": kGray, "lineWidth": 4, "label":"SingleTopBar t"    },
{"name":"STtW",   "selection": "(1)", "file": loc + "result_SingleTop_tW.root",  "cx":35.6,   "color": kGray, "lineWidth": 4, "label":"SingleTopBar tW"   },
